...
var cold=g.Parts(1,TycoonPart.Kind.Shelf).First();
...
string evidence="Experienced park worker earned $15.50 from a double bowl with nuts and whipped cream. Both installed tubs started at 6, were filled to 24, and finished at 23. Two partial refills returned to shelf storage with 6 each. Tools and containers stayed in the worker inventory.";
