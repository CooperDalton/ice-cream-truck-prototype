...
public static class TycoonFinishingAuthoring
{
    public static void Apply()
    {
        ...
        ui.assignLockerButton = Button(ui.closeButton,"Assign next locker",ui.inventoryPanel.transform,new Vector2(-245,-190),new Vector2(420,48));
        ui.newGameButton = Button(ui.saveButton,"New campaign",ui.menuPanel.transform,new Vector2(255,-16),new Vector2(320,46));
        ui.quitButton = Button(ui.saveButton,"Save and quit",ui.menuPanel.transform,new Vector2(255,-74),new Vector2(320,46));
        ...
        for (int i=0;i<ui.supplyButtons.Length;i++) { var r=ui.supplyButtons[i].GetComponent<RectTransform>();r.anchoredPosition=new Vector2(-420+i%4*280,200-i/4*51);r.sizeDelta=new Vector2(264,43); }
